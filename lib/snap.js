...
Snap = (function(superClass) {
  ...
  Snap.prototype._init = function() {
    ...
    if (this.opts.align) {
      ...
      this.horizental_line = $('<div class="horizontal_line"></div>').appendTo("body").hide();
      this.vertical_line = $('<div class="vertical_line"></div>').appendTo("body").hide();
      this.dragdrop.on('drag', (function(_this) {
        return function(e, obj) {
          ...
          wrapper = $(_this.dragdrop.opts.el);
          $dragging = obj.helper;
          ...
          if (align_y) {
            ...
            return _this.vertical_line.show();
          }
        };
      })(this));
      ...
      return this.dragdrop.on('dragdestroy', (function(_this) {
        return function() {
          _this.horizental_line.remove();
          return _this.vertical_line.remove();
        };
      })(this));
    }
  };
  ...
  Snap.prototype._align = function(target, references, edges, line) {
    ...
    min_distance = this.opts.alignOffset;
    align_edge = null;
    align_obj = null;
    move = null;
  ...
  Snap.prototype._adjacent = function(target, references) {
    ...
    $.each(references, (function(_this) {
      return function(index, ele) {
        ...
        if (distance.x < _this.opts.alignOffset && distance.y < _this.opts.range) {
          $ele.data('distance', distance.y);
          adjacent_x.push($ele);
        }
        if (distance.y < _this.opts.alignOffset && distance.x < _this.opts.range) {
  ...
  Snap.prototype._distance = function(target, reference) {
    ...
    referenceX = reference.offset().left + reference.width() / 2;
    referenceY = reference.offset().top + reference.height() / 2;
    distance = {
