class Snap extends SimpleModule
  ...
  _init: ->
    ...
    if @opts.align
      ...
      @horizental_line = $('<div class="horizontal_line"></div>').appendTo("body").hide()
      @vertical_line = $('<div class="vertical_line"></div>').appendTo("body").hide()
